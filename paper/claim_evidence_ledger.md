...
| D-MHW | `docs/dmhw_direct_multi_horizon_stage0.md`; `artifacts/g1/dmhw_preflight_9f6a9d3.json` | Direct 0.5/1.5/2.5 s exact-10k mechanism preflight passed on H200 with forced persistent Doppler warp, 7k/3k persistent/birth split, all-channel gradients, and five differentiable interventions. Real training is locked: no eligible geometry parent, train target cache `0/1480`, and real birth-Doppler supervision is unresolved without a future Cube. |
