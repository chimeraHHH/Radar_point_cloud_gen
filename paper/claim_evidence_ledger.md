...
| G1D | `docs/g1d_rald_query_field_protocol.md`; `docs/g1d_rald_source_map.md`; `artifacts/g1/g1d_preflight_bd23a4f2.json`; server root `formal_bd23a4f_g1d_rald_query_field` | H200 structural preflight passed at source `bd23a4f2`; first Stage A launch was stopped before any epoch metric to add an exact-equivalent proposal-index cache; no scientific gate result yet |
