...
| G1D | `docs/g1d_rald_query_field_protocol.md`; `docs/g1d_rald_source_map.md`; `artifacts/g1/g1d_preflight_bd23a4f2.json`; server root `formal_bd23a4f_g1d_rald_query_field` | H200 structural preflight passed at source `bd23a4f2`; Stage A seed 20260716 is running; no scientific gate result yet |
