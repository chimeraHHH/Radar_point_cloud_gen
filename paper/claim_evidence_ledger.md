...
| G1D | `docs/g1d_rald_query_field_protocol.md`; expected server root `formal_<source>_g1d_rald_query_field` | New RaLD-structured route; implementation active, no result yet |
