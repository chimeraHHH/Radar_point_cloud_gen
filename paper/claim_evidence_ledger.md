...
| R-A1 RaLD-WCE | `docs/g1_ra1_rald_wce_stage0_protocol.md`; `artifacts/g1/wce_smoke_f2a9489/`; earlier model preflight `artifacts/g1/rald_wce_preflight_2b78b16.json` | Source `f2a9489` passed H200 targeted and full regression tests plus 500k-Q0/200k-Q1 exact-10k pressure testing. Formal 20-epoch Stage-0 is running on GPU2. Smoke metrics are engineering-only; the route currently outputs XYZ+confidence and makes no Doppler or scientific geometry claim. |
