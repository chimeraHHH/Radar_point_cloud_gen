...
from losses.doppler_distribution import distribution_cross_entropy
...
def anchor_refinement_loss(
    ...
    *,
    ...
    _, direct_match = nearest_target_assignment(
        output["anchor_xyz_m"][0].float(), target_xyz
    )
    direct_matched_target_spectrum = all_target_spectrum[direct_match]
    ...
    components = {
        ...
        "doppler_cross_entropy": doppler.detach(),
