...
- [docs/p3_progress_2026-07-05.md](docs/p3_progress_2026-07-05.md)：**P3 预研纪要**——时序条件 ≫ LiDAR 条件(CD 8.5→7.2)；0.25s 视距 dopp-warp 条件无增益(负结果)；复制条件基线完爆从头生成；SDEdit 精修反伤草稿(模型瓶颈)；**dopp-warp 草稿 0.5s 起占优(视距翻转)→ **桥式扩散(RF+OT配对)验证成功:CD 7.7→4.0、MMD↓79%、修复复制的物理陈旧(PCE 19.7%→40.4%≈GT)**。
