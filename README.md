...
- [docs/p3_progress_2026-07-05.md](docs/p3_progress_2026-07-05.md)：**P3 预研纪要**——时序条件 ≫ LiDAR 条件(CD 8.5→7.2)；0.25s 视距 dopp-warp 条件无增益(负结果)；**复制条件基线完爆从头生成 → 指向 SDEdit 式部分扩散架构**。
